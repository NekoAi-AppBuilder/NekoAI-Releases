...
import {
  ...
  projectKey,
} from "../dist/main/lovable/lovable-vault.js";
...
// ============================================================================
// 5. TESTES DE SEGURANÇA E SANITIZAÇÃO DE ERROS
// ============================================================================

test("Lovable Security: sanitização de mensagens de erro impede vazamento de JWT e credenciais", () => {
...
test("Lovable Security: validação estrita de UUID impede SQL Injection nos parâmetros da query", () => {
  const maliciousInput = "123e4567-e89b-12d3-a456-426614174000'; DROP TABLE users; --";
  assert.equal(LOVABLE_PROJECT_ID_REGEX.test(maliciousInput), false);
});
